	...
	public function CreateTeam()
	{
		...
		//获取输入，其中队长名由SESSION得到；同样使用strip_tags
			...
			if (isset($_POST['team_member1'])) {
				...
				$query = $this->db->prepare("SELECT user_team FROM users WHERE user_nickname = :user_nickname");
			...
			$query = $this->db->prepare("INSERT INTO teams 
				(team_name, team_password_hash, team_slogan, team_captain, team_member1, team_member2, team_full)
