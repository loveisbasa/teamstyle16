        ...
        $code.= dechex(mt_rand(0, 15)); //dechex — 十进制转换为十六进制
         ...
         for ($i = 0; $i < $line_num; $i++) {
              ...
              imagechar($img, 1, mt_rand(0, $width) , mt_rand(0, $high) , '*', imagecolorallocate($img, mt_rand(200, 255) , mt_rand(200, 255) , mt_rand(200, 255)));
               ...
               for ($b = 0; $b < strlen($code); $b++) {
              imagechar($img, 5, $b * $width / $num + mt_rand(5, 10) , mt_rand(2, $high / 2) , $code[$b], imagecolorallocate($img, mt_rand(10, 150) , mt_rand(10, 150) , mt_rand(0, 100)));
              }
